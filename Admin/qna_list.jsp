	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr> 
					<td height=40 align="center" style="font-size: 15px;"><b>질의응답</b></a>
					</b></td>
				</tr>
			</table><br>
				...
				<tr>
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
                      <tr bgcolor="EcECEC">
                        <td width="5%" align="center" bgcolor="EcECEC"><strong>번호</strong></td>
                        <td width="10%"align="center"><strong>질의유형</strong></td>
						<td align="center" bgcolor="EcECEC"><strong>제목</strong></td>
						<td width="10%" align="center"><strong>글쓴이</strong></td>
                        <td width="10%" align="center"><strong>접수일</strong></td>
                        <td width="10%" align="center"><strong>답변일</strong></td>
                        <td width="10%" align="center"><strong>담당자</strong></td>
                        <td width="10%" align="center"><strong>조회수</strong></td>
                      </tr>
                      <tr>
                        <td align="center" bgcolor="#FFFFFF">1</td>
                        <td align="center" bgcolor="#FFFFFF">Java</td>
                        <td bgcolor="#FFFFFF">안녕하세요</td>
                        <td align="center" bgcolor="#FFFFFF">홍길동</td>
						<td align="center" bgcolor="#FFFFFF">2007-10-11</td>
						<td align="center" bgcolor="#FFFFFF">2007-10-11</td>
						<td align="center" bgcolor="#FFFFFF">관리자A</td>
                        ...
                        <td colspan="10" align="center" bgcolor="#FFFFFF"><table width="610" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width=80% height="30" colspan="2" align="right">
								질의유형 <select name="gubun" class="textfield">
									<option>Java</option>
								</select>&nbsp;&nbsp;
                              ...
                              <td width=20% align="right"><b>[검색]</b>  &nbsp;</td>
                            </tr>
                        </table></td>
                      </tr>
                    </table>
