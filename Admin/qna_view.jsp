	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr> 
					<td height=40 align="center" style="font-size: 15px;"><b>질의 응답 보기</b></a>
					</b></td>
				</tr>
			</table><br>
			<table width="80%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							<tr>
								<td width="18%" align="center" bgcolor="EcECEC"><strong>질의유형/제목</strong></td>
								<td width="48%"bgcolor="ffffff">[Java] / 안녕하세요</td>
								<td width="18%" align="center" bgcolor="EcECEC"><strong>작성자</strong></td>
								<td align="center" bgcolor="ffffff">홍길동</td>
							</tr>
							<tr>
								<td align="center" bgcolor="EcECEC"><strong>등록일/답변일</strong></td>
								<td bgcolor="ffffff">2000-10-11 / 2000-10-12</td>
							...
							<tr bgcolor="EcECEC">
								<td align="center" bgcolor="EcECEC"><strong>답변내용</strong></td>
								<td colspan=3 bgcolor="ffffff"><textarea name="" cols="80%" rows="3">질의에 대한 답변입니다.안녕하세요.
								반갑습니다</textarea></td>
							</tr>
						</table>
						<!-- 답변 -->
